    ...
    <div class="row mx-4 my-4">
        ...
        <?php
            ...
            switch ($source) {// we need a condition to compare it with below cases
                case 'add_post';
                    include "includes/add_post.php"; //code will be right here get method eken use karane source=add_post url type karapn
                    break;
                    /* create a another page and include in the switch statement  */
                 case 'edit_post';
                    include "includes/edit_post.php"; //code will be right here=
                    break;

                
                
                default:
                    include_once "includes/view_all_posts.php"; // to display table all the time
                    break;
            }
